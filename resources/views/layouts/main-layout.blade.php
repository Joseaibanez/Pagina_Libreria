...
<body>
    <header class="d-flex p-2 bd-highlight p-3 mb-2 bg-success">
        <div class="container">
            <div class="row">
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 text-end d-flex">
                    <a class="nav-link text-light" href="http://localhost:8000/login">Iniciar sesión</a>
                    <a class="nav-link text-light" href="http://localhost:8000/carrito">
    ...
    <footer class="text-center text-lg-start bg-light text-muted">
        ...
        <section class="">
            <div class="container text-center text-md-start mt-5">
                <div class="row mt-3">
                    ...
                    <p>
                        <a href="#!" class="text-reset">Ver todos</a>
                    </p>
                    <p>
                        <a href="#!" class="text-reset">Humanidades</a>
                    </p>
                    <p>
                        <a href="#!" class="text-reset">Técnico y formación</a>
                    </p>
                    <p>
                        <a href="#!" class="text-reset">Literatura</a>
                    </p>
                    </div>
        ...
        <div class="text-center p-4" style="background-color: rgba(0, 0, 0, 0.05);">
            © 2022 Jose Antonio Ibáñez; DWES 2º DAW
        </div>
    </footer>
    <!-- Fin Footer -->
    @yield('js')
